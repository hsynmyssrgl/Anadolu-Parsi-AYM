...
echo Build221 / 02.08.2026.221
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\run-build221-bronze-security-closure.ps1"
...
echo.
echo artifacts\validation klasorundeki Bronze_Guvenlik_Windows_Kanitlari_Build221_*.zip ve .sha256 dosyalarini saklayin.
pause

...
echo Build220 / 02.08.2026.220
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\run-build220-bronze-security-closure.ps1"
...
echo.
echo artifacts\validation klasorundeki Bronze_Guvenlik_Windows_Kanitlari_Build220_*.zip ve .sha256 dosyalarini saklayin.
pause

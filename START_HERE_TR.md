...
Bu kaynak Bronze aktif geliştirme kanalındadır. Silver ve Gold; ayrı uygulama kimliği, kurulum yolu, kullanıcı-verisi kökü ve kod çalışma ağacı kullanır. İmzasız yerel kurulum paketi üretim teslimi değildir.

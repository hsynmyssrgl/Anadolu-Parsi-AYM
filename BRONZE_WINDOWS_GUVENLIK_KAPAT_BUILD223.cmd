...
echo Build223 / 02.08.2026.223
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\run-build223-bronze-security-closure.ps1"
...
echo.
echo artifacts\validation klasorundeki Bronze_Guvenlik_Windows_Kanitlari_Build223_*.zip ve .sha256 dosyalarini saklayin.
pause

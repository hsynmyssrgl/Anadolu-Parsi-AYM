...
echo Build225 / 02.08.2026.225
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\run-build225-bronze-security-closure.ps1"
...
echo.
echo artifacts\validation klasorundeki Bronze_Guvenlik_Windows_Kanitlari_Build225_*.zip ve .sha256 dosyalarini saklayin.
pause

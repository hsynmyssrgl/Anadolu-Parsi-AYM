...
export const PLATFORM_POLICY_PROVIDER_CLOCK_SKEW_TOLERANCE_MS = 5_000 as const;
...
export class PlatformPolicyEnforcementPoint {
  ...
  public async execute<T>(
    ...
    if (
      ...
      receiptIssuedAtMs < issuedAtMs - PLATFORM_POLICY_PROVIDER_CLOCK_SKEW_TOLERANCE_MS
      || receiptIssuedAtMs > providerReturnedAtMs + PLATFORM_POLICY_PROVIDER_CLOCK_SKEW_TOLERANCE_MS ||
    ...
    if (!Number.isFinite(executionStartedAtMs)
      || executionStartedAtMs + PLATFORM_POLICY_PROVIDER_CLOCK_SKEW_TOLERANCE_MS < receiptIssuedAtMs

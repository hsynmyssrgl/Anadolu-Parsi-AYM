...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | Exact hedefli 94 dosya/598 test PASS. Onceki no-write, belge ve indeks retleri korunur. 703be65a/0a118f5f/7fb288cd runtime onkosullarini, ddb1abff alt surec no-write sizintisini ve dd675310 Poppler render PATH eksigini korur. Resmi build onkosullariyla 16/16 ek runtime PASS; no-write duzeltmesi 1 dosya/6 test, uc runtime ve uc byte-exact manifest SHA PASS; exact Poppler/LibreOffice retry 28/28 sayfa gorsel QA PASS verdi. Yeni exact hedefli/tam regresyon/kaynak butunlugu PASS olmadan paket veya kurulu EXE UAT yok |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Onceki no-write, belge, kimlik, hedefli cagri ve indeks retleri korunur. 703be65a/0a118f5f/7fb288cd runtime build/tani onkosullarini, ddb1abff alt surec no-write sizintisini ve dd675310 Poppler render PATH eksigini gercek FAIL korur. 16/16 ek runtime, 1 dosya/6 test, uc runtime, uc byte-exact manifest SHA ve exact Poppler/LibreOffice retry 28/28 sayfa gorsel QA PASS verdi. Yeni exact hedefli/tam/typecheck/sozdizimi/kaynak butunlugu ve tam UAT PASS olmadan ara installer yok |

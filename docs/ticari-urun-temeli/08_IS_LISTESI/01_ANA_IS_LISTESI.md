...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Onceki FAIL checkpointleri korunur. Uc kanal 1.428/1.428 checkpoint yoluyla tamdir. 50f4d9e5, current-mutation preflight alaninda tarihsel FAIL metni tasinmasini kaydeder; alan NOT_RUN_CURRENT_MUTATION olur. Yeni exact hedefli/tam/typecheck/sozdizimi/kaynak butunlugu/preflight ve tam UAT PASS olmadan ara installer yok |

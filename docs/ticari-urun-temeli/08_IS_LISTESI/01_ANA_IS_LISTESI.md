...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | Aktif son kaynak reti `de63eb2b`; `a5334c13` Bronze 52 release görsel retidir. Bronze 53 tek kez tahsis edildi. Yeni exact hedefli/tam/bütünlük, paket, `.52→.53` kurulu EXE UAT ve final readback olmadan teslim yok |
| IS-0212 | Acik tek seferli surum tahsisi ve onceden tahsisli paket kimligi | Codex | DEVAM | Bronze 27.08.2026.53, `bronze-2026-08-27-r53` kimliğiyle tek kez tahsis edildi; allocator tekrar çalıştırılmaz. `.52` history parent `.51`, `.53` history parent `.52` exact kaydedilir. Aktif son kaynak reti `de63eb2b`; yeni exact kapılar pendingdir |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Aktif son ret `de63eb2b`; tracked teknik dosya indeks eksiğidir. `cb7a5d4d` ticari makbuz durum sözleşmesi ve `453e8c59` master marker driftleri korunur. Atomik installer boyaması 4 dosya/43, teknik predecessor producer retryı 1 dosya/10, enforcement retryı 8 dosya/74 ve güncel UAT/final/kayıt çapraz sözleşme retryı 7 dosya/75 test PASS; final master 59/59 görsel QA PASS. Bronze 53 yeni exact zincir ve tam UAT PASS olmadan kapanmaz |

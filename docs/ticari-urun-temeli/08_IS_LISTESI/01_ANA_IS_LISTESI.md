...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | Bronze 51 predecessor packaged runtime kimliğiyle canlı PASS. f4f84896 hedefli 19 dosya/191 test PASS ve tam 399 dosya/2.483 test PASS iken PPK-015 ratchet FAIL 8ea2dfe1, ilk contract ayırıcı FAIL 24e6bd71 ile korunmuştur. Bronze 52 yeni exact hedefli/tam/bütünlük, paket ve kurulu EXE UAT olmadan teslim yok |
| IS-0212 | Acik tek seferli surum tahsisi ve onceden tahsisli paket kimligi | Codex | DEVAM | Bronze 27.08.2026.52, `bronze-2026-08-27-r52` kimliğiyle tek kez tahsis edildi; allocator tekrar çalıştırılmaz. Aktif son gerçek ret 24e6bd71, d68fd2a4 invocation-only'dir. `.51` immutable önceki paket olarak korunur; `.52` full exact kapılar, paket ve kurulu UAT pendingdir |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Aktif son ret 24e6bd71. Canlı PPK-015 özeti f54e3f302649af67ed6d028e66673eea68b0d58c2ba43c912c1ccb7534babe98 değerine eşlenir ve tarihsel `migration 117` ayırıcısı geri kurulur; ağ yetkisi değişmemiştir. Yeni exact zincir ve tam UAT PASS olmadan kapanmaz; ara installer yok |
| IS-0216 | Bronze 51 rejected predecessor recovery bootstrap | Codex | DEVAM | Bronze 50 immutable REJECTED_INVALID_PACKAGE ve Bronze 51 immutable package geçmişi korunur. .51 package/provenance/installer-experience ve canlı predecessor bundle readback PASS. 8ea2dfe1 stale kaynak ratchet'ini, 24e6bd71 ilk contract ayırıcı FAIL'ini korur; Bronze 52 yeni exact kapılar, paket ve canlı UAT tamamlanmadan teslim edilmez |
...
| ID | Is | Sorumlu | Durum | Kabul |
|---|---|---|---|---|
| IS-0601 | Tam regresyonu yeni kaynakta tekrar kos | Codex | DEVAM | f4f84896 turunda hedefli 19 dosya/191 test PASS; filtresiz 399 dosya/2.483 test PASS ve PPK-015 ratchet FAIL 8ea2dfe1 ile korunmuştur. İlk contract retry ayırıcı FAIL'i 24e6bd71 ile korunur. Ayırıcı eşlemesi sonrası Bronze 52 yeni exact hedefli/tam tur, TypeScript, sözdizimi ve kaynak bütünlüğü zorunlu |

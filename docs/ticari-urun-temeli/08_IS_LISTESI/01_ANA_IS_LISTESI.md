...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | Exact hedefli 94 dosya/598 test PASS. Onceki no-write, belge ve indeks retleri korunur. 703be65a 398 dosya/2.469 test PASS sonrasinda 16 ek runtime dist onkosulu FAIL; 0a118f5f eksik resmi npm tani ortami; 7fb288cd eksik core-service dist ve ddb1abff 33-Y/33-Z/34-A alt surec no-write sizintisi retleridir. Resmi package/core-service/desktop onkosullariyla 16/16 ek runtime PASS; ortak no-write duzeltmesi 1 dosya/6 test, uc runtime ve uc byte-exact manifest SHA PASS verdi. Yeni exact hedefli/tam regresyon/kaynak butunlugu PASS olmadan paket veya kurulu EXE UAT yok |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Onceki no-write, belge, kimlik, hedefli cagri ve indeks retleri korunur. 703be65a/0a118f5f/7fb288cd Bronze runtime build ve tani onkosullarini; ddb1abff 33-Y/33-Z/34-A alt surec no-write sizintisini gercek FAIL korur. Resmi build onkosullariyla 16/16 ek runtime PASS; ortak aktarimla 1 dosya/6 test, uc runtime ve uc byte-exact manifest SHA PASS verdi. Ana belge 28/28 gorsel QA PASS kalir. Yeni exact hedefli/tam/typecheck/sozdizimi/kaynak butunlugu ve tam UAT PASS olmadan ara installer yok |

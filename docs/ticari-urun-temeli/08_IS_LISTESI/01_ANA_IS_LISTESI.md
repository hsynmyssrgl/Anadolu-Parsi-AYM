...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | Bronze 51 predecessor packaged runtime kimliğiyle canlı PASS. d68fd2a4 invocation-only; 3976994d packageStatus hedefli test, fb8683dc Windows PowerShell Unicode sınıflandırma odaklı test retidir. Bronze 52 yeni exact etki/hedefli/tam/bütünlük, paket ve kurulu EXE UAT olmadan teslim yok |
| IS-0212 | Acik tek seferli surum tahsisi ve onceden tahsisli paket kimligi | Codex | DEVAM | Bronze 27.08.2026.52, `bronze-2026-08-27-r52` kimligiyle tek kez tahsis edildi; allocator tekrar calistirilmaz. Aktif son gerçek ret 61f09ed5, d68fd2a4 invocation-only'dir. `.51` immutable önceki paket olarak korunur; `.52` full exact kapılar, paket ve kurulu UAT pendingdir |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Aktif son ret 61f09ed5; TICARI-052 marker düzeltmesi sonrası 1.254 kontrol/87 dosya/61 iş/241 kural PASS. d68fd2a4 invocation-only'dir. Yeni exact hedefli/tam/typecheck/sözdizimi/kaynak bütünlüğü/read-only pre/postflight ve tam UAT PASS olmadan kapanmaz; ara installer yok |
| IS-0216 | Bronze 51 rejected predecessor recovery bootstrap | Codex | DEVAM | Bronze 50 immutable REJECTED_INVALID_PACKAGE ve Bronze 51 immutable package geçmişi korunur. .51 package/provenance/installer-experience ve canlı predecessor bundle readback PASS. Bronze 52 continuation exact kapılar, uninstall sicili düzeltmesi, yeni paket ve canlı UAT tamamlanmadan teslim edilmez |
...
| ID | Is | Sorumlu | Durum | Kabul |
|---|---|---|---|---|
| IS-0601 | Tam regresyonu yeni kaynakta tekrar kos | Codex | DEVAM | 3b31753b tam kapanış yalnız tarihsel PASS'tir. 3976994d packageStatus ve fb8683dc Windows PowerShell sınıflandırma test hatalarını korur; düzeltme sonrası Bronze 52 yeni temiz exact hedefli/tam tur, TypeScript, sözdizimi ve kaynak bütünlüğü zorunlu |

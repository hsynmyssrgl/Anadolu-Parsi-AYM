...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | c02744cd exact Bronze resmi npm tam regresyonu 398 dosya/2.469 test ve 171/171 ek komut PASS verdi. Kaynak butunlugu 683 eksik Git-disi manifest payloadi ve linked-worktree .git dosyasi nedeniyle 684 bulguyla FAIL olup 7d67fcff ile korundu. Uc kanala hash-bound payload esitlemesi ve .git dislamasi odakli 2 dosya/9 test PASS; yeni exact hedefli/tam regresyon ve kaynak butunlugu PASS olmadan paket veya kurulu EXE UAT yok |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Onceki FAIL checkpointleri korunur. Yeni 7d67fcff, c02744cd tam regresyon PASS sonrasinda exact Bronze kaynak butunlugunun 683 eksik Git-disi payload ve bir linked-worktree .git girdisiyle durmasini kaydeder. Kalici kanal payload esitlemesi ve kaynak toplayici duzeltmesi 2 dosya/9 test PASS verdi. Yeni exact hedefli/tam/typecheck/sozdizimi/kaynak butunlugu ve tam UAT PASS olmadan ara installer yok |
...
| ID | Is | Sorumlu | Durum | Kabul |
|---|---|---|---|---|
| IS-0601 | Tam regresyonu yeni kaynakta tekrar kos | Codex | DEVAM | c02744cd exact kaynakta 398 dosya/2.469 test ve 171/171 ek komut PASS; source-integrity 4.868/4.186/4.869 ve 684 bulguyla FAIL. 7d67fcff kaydi ve duzeltme sonrasi yeni exact tur zorunlu |

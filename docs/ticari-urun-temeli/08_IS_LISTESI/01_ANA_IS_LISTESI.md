...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | 0099e39e yanlış kök assessment çağrısını reddeder. Exact Bronze assessment 109 yol/21 hedef test ve analysis 109 yol PASS; P2 source/baseline exact bağı 2 dosya/8 test PASS. Yeni exact hedefli/tam/bütünlük ve kurulu EXE UAT olmadan teslim yok |
| IS-0212 | Acik tek seferli surum tahsisi ve onceden tahsisli paket kimligi | Codex | DEVAM | Bronze 26.08.2026.51 exact expected release ID ile tek kez tahsis edildi; allocator tekrar calistirilmaz. Yeni PR-241 hash zincirinde recovery kimlik, PE/takvim, union ve master yonetisim audit duzeltmeleri 8 dosya/85 test PASS; full exact kapilar, paket ve kurulu UAT pendingdir |
| IS-0213 | Kanonik kurulu Windows yukseltme maintenance ve on yuz UAT zinciri | Codex | DEVAM | Sequence 50/51/52+ exact union, pre-install PE/paket/takvim/surum ve kanonik parent packageVersion audit duzeltmeleri yeni PR-241 hash zincirinde master yonetisim dahil 8 dosya/85 test PASS; gercek build, recovery install, maintenance UAT110/UAT111 pendingdir |
| IS-0214 | Adversarial Windows package kurulum ve final teslim kanit zinciri | Codex | DEVAM | UAT110 V3 Bronze 50 bootstrap / exact Bronze 51 recovery / Bronze 52+ continuation sozlesmesi audit edildi ve yeni PR-241 hash zincirinde master yonetisim dahil 8 dosya/85 test PASS; full exact kapilar, build, installer experience, UAT110/UAT111 ve final kurulu UAT NOT_RUN |
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | 0099e39e aktif son yanlış kök checkpointidir. Assessment sourceCommit/baselineCommit exact bağı ve bütün kayıtlar kapatıldı; final-freeze6 belge QA 25 byte-exact + 32 yeniden incelenen sayfayla 57/57 PASS. Yeni exact hedefli/tam/typecheck/sözdizimi/kaynak bütünlüğü/preflight ve tam UAT PASS olmadan kapanmaz; ara installer yok |
| IS-0216 | Bronze 51 rejected predecessor recovery bootstrap | Codex | DEVAM | Bronze 50 immutable REJECTED_INVALID_PACKAGE korunur. Exact Bronze assessment 109 yol/21 hedef test, analysis 109 yol ve P2 commit bağı 2 dosya/8 test PASS; final-freeze6 belge QA 57/57 PASS. 6f9139e1 sonuçları yalnız tarihsel PASS'tir; yeni exact kapılar, paket ve canlı UAT tamamlanmadan teslim edilmez |
...
| ID | Is | Sorumlu | Durum | Kabul |
|---|---|---|---|---|
| IS-0601 | Tam regresyonu yeni kaynakta tekrar kos | Codex | DEVAM | 6f9139e1 hedefli 21 dosya/211 test ve full 399 dosya/2.481 test yalnız tarihsel PASS'tir. P2 assessment exact commit bağı son kaynak değişikliğidir; yeni temiz exact hedefli/tam tur ve kaynak bütünlüğü zorunlu |

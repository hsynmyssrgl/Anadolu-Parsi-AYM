...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | d421c299 exact Bronze hedefli 95 dosya/600 test, tam 399 dosya/2.471 test, 172/172 ek komut ve 4.869/4.869 kaynak butunlugu PASS verdi. Preflight 607a9a53 ve 8b2b5ccc ile guncel makbuz ve 803 checkpoint payload eksigini fail-closed korudu. Kalici kanal esitlemesi sonrasi yeni exact kapilar olmadan paket veya kurulu EXE UAT yok |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Onceki FAIL checkpointleri korunur. 607a9a53 temizlenen installer makbuzlarinin yeniden uretim eksigini, 8b2b5ccc tamamlanmis adimlarin 1.428 gerekli yolundan 803 Git-disi checkpoint payload eksigini kaydeder. Ana kaynak 1.428/1.428 tamdir; kanal kurulumu tamamlanmis localEvidence/receipt esitlemesiyle duzeltilmektedir. Yeni exact hedefli/tam/typecheck/sozdizimi/kaynak butunlugu/preflight ve tam UAT PASS olmadan ara installer yok |
...
| ID | Is | Sorumlu | Durum | Kabul |
|---|---|---|---|---|
| IS-0601 | Tam regresyonu yeni kaynakta tekrar kos | Codex | DEVAM | d421c299 exact Bronze hedefli 95 dosya/600 test, tam 399 dosya/2.471 test, 172/172 ek komut ve source-integrity 4.869/4.869 PASS. 8b2b5ccc checkpoint payload duzeltmesi final kaynak degisikligi oldugundan yeni exact tur zorunlu |

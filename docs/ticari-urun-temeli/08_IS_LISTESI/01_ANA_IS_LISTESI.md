...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | d8746da8 hedefli 76 dosya/509 test PASS; filtresiz regresyon, bicim ve kanal-cwd test FAIL'leri a7d50f72/925d25d1/e42f9b58/4894345b/88fb84f8/447eb103/90b0fb0f/5490c2b4/284545ff/41c16c13 rejected checkpointleriyle korundu. Son exact hedefli turda 596 test PASS olurken governed-source-root ana kaynak testi FAIL verdi; test explicit ana kaynak ve mevcut exact checkout ayrimina duzeltildi. Kanal kok tasinabilirligi, temiz data-store hazirligi, kanonik PPK-015 current ratchet, build ledger tek satir sonu ve 47/47 ek komut on kosumu PASS; yeni exact commit tam regresyon/kaynak butunlugu PASS olmadan paket veya kurulu EXE UAT yok |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Ignored eski rapor test gercegi olamaz; canli JSON stdout/kanonik surum, exact Git koklu salt-okunur kanal dogrulamasi, tekrarlanabilir smoke derlemesi ve tarihsel snapshot'tan ayrik kanonik current ratchet zorunlu. Tum bagimli kayitlar UPDATED veya baseline diff yoklugu + gerekce + assessment/analysis/readback SHA bagi ile kanitli NOT_AFFECTED; hedefli/tam/typecheck/sozdizimi/kaynak butunlugu ve UI etkisinde tam UAT PASS, gercek FAIL wip(rejected), ara installer yok |

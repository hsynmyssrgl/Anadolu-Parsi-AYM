...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | Aktif son kaynak reti `5d2b962d`; `2eeaac0b` PPK-015 ratchet reti focused 2 dosya/23 test, contract 43/43 ve runtime 10/10 PASS ile düzeltildi. `5d2b962d` master öncesi ticari doğrulayıcı marker sırası retidir. `a5334c13` Bronze 52 release görsel retidir. Yeni exact hedefli/tam/bütünlük, paket, `.52→.53` kurulu EXE UAT ve final readback olmadan teslim yok |
| IS-0212 | Acik tek seferli surum tahsisi ve onceden tahsisli paket kimligi | Codex | DEVAM | Bronze 27.08.2026.53, `bronze-2026-08-27-r53` kimliğiyle tek kez tahsis edildi; allocator tekrar çalıştırılmaz. `.52` history parent `.51`, `.53` history parent `.52` exact kaydedilir. Aktif son kaynak reti `5d2b962d`; yeni exact kapılar pendingdir |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Aktif son ret `5d2b962d`; ticari doğrulayıcı master aktif checkpoint markerı üretilmeden önce çağrılmıştır. Retry master-önce üretici sırasıdır. `2eeaac0b` PPK-015 ratchet reti focused 2 dosya/23 test, contract 43/43, runtime 10/10 PASS ile düzeltildi; ağ yetkisi değişmedi. Önceki retler tarihsel korunur; Bronze 53 yeni exact zincir ve tam UAT PASS olmadan kapanmaz |

...
| IS-0211 | Mutasyon sonrasi exact commit kanit ve taze kurulu EXE UAT kapisi | Codex | DEVAM | UAT110 pre-install registry harness retleri 059e3787, a1aec744, 8472face, 15e3c9d0 ve son 64695e58 ile korunur. Düzeltme 2 dosya/17 test, pre-mutation baseline 15e3c9d0 PASS. Bronze 52 exact etki/hedefli/tam/bütünlük ve kurulu EXE UAT olmadan teslim yok |
| IS-0212 | Acik tek seferli surum tahsisi ve onceden tahsisli paket kimligi | Codex | DEVAM | Bronze 27.08.2026.52, `bronze-2026-08-27-r52` kimligiyle tek kez tahsis edildi; allocator tekrar calistirilmaz. `.51` immutable onceki paket olarak korunur. `.52` full exact kapilar, paket ve kurulu UAT pendingdir |
| IS-0213 | Kanonik kurulu Windows yukseltme maintenance ve on yuz UAT zinciri | Codex | DEVAM | Bronze 51 exact paket ve installer-experience PASS; ilk UAT110 installer başlamadan registry harness içinde reddedildi ve düzeltme 2 dosya/17 test PASS. Exact .51 predecessor kurulup bundle ile doğrulanacak; Bronze 52 N→N+1, maintenance ve UAT111 pendingdir |
...
| IS-0215 | En kucuk degisiklikte tum kayit ve test kapanisi | Codex | DEVAM | Aktif son ret 2ca29a6d ticari son-kayıt preflight driftidir; TICARI-052 düzeltmesi sonrası governed writer PASS. 15e3c9d0 pre-mutation baseline ve registry harness düzeltmesi 2 dosya/17 test PASS. Yeni exact hedefli/tam/typecheck/sözdizimi/kaynak bütünlüğü/read-only pre/postflight ve tam UAT PASS olmadan kapanmaz; ara installer yok |
| IS-0216 | Bronze 51 rejected predecessor recovery bootstrap | Codex | DEVAM | Bronze 50 immutable REJECTED_INVALID_PACKAGE ve Bronze 51 immutable package geçmişi korunur. .51 package/provenance/installer-experience PASS; pre-install UAT110 harness retleri düzeltildi. Bronze 52 continuation exact kapılar, .51 predecessor readback, yeni paket ve canlı UAT tamamlanmadan teslim edilmez |
...
| ID | Is | Sorumlu | Durum | Kabul |
|---|---|---|---|---|
| IS-0601 | Tam regresyonu yeni kaynakta tekrar kos | Codex | DEVAM | 3b31753b hedefli 21 dosya/211 test ve full 399 dosya/2.481 test yalnız tarihsel PASS'tir. UAT110 registry harness düzeltmesi 2 dosya/17 test PASS; Bronze 52 yeni temiz exact hedefli/tam tur ve kaynak bütünlüğü zorunlu |
...
UAT110 registry harness ve Bronze 52 geçiş kaydı: `059e3787` canlı pre-install snapshot FAIL, `a1aec744`, `8472face`, `15e3c9d0` strict-mode düzeltme FAIL ve `64695e58` test modülü çağrı FAIL checkpointleridir. Installer başlamamış, kurulu EXE/UAT111 oluşmamış ve 15 AppData dosyası değişmemiştir. Property-safe okuma ile sıfır kayıt dizi düzeltmesi 2 dosya/17 test, `15e3c9d0` pre-mutation baseline PASS'tir. İlk Bronze 52 governed writer turundaki sabit TICARI-051 son-kayıt driftini `2ca29a6d` korur; TICARI-052 exact tekil son kayıt düzeltmesi sonrası retry PASS'tir. `IS-0211`–`IS-0216` ve `IS-0601`, Bronze 52 exact test/paket/N→N+1 UAT kapanana kadar `DEVAM` kalır.

...
check(manifest.id === 'PARSYUVA-AILE-YASAM-MERKEZI-TICARI-TEMEL-20260822-04', 'manifesto kimligi degisti');
check(manifest.baselineDate === '2026-08-22', 'temel tarihi degisti');
...
check(workRegistry.toplamIs === 54, `makine is sayisi 54 olmali: ${workRegistry.toplamIs}`);

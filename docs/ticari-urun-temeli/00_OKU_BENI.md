...
Guncel ust kayit Bronze 22.08.2026.49 ve DEC-268'dir. Kanonik V21 SHA-256 ozeti `cb02fed18fb3ca097877ed3be73fbaacea60c8e291498fbeb21c28f9ad9e5a90` olarak yenilenmistir. DEC-268; `.46` NSIS callback, `.47` stale dahili NSIS payload ve `.48` ilk 2FA sonrasi policy authority FAIL kayitlarini korur; retention ile guvenilir cihaz bootstrap kapsamlarini kalici kapatir ve `.49` temiz installer, paketli/kurulu runtime ile sentetik on yuz kullanici UAT zincirini yetkilendirir. Asagidaki onceki `.46` ozeti tarihsel baglamdir; guncel kaynak degildir.

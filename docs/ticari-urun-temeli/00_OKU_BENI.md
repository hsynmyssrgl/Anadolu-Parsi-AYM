...
Guncel ust kayit Bronze 22.08.2026.50 ve DEC-269'dur. Kanonik V22, 234 kural ve SHA-256 `67462d63e873b68a1eacfb358f904226d9199f99c81950645e05350df9963506` ile baglidir. DEC-269/PR-234 Bronze, Silver ve Gold kanallarini kurulum dizini, EXE, kisayol, appId, kullanici veri koku, kaldirma kapsami, Git worktree ve branch duzeyinde ayirir; bir kanal digerinin programini, verisini veya build ciktisini degistiremez. DEC-268'in temiz installer ve tam on yuz UAT zinciri korunur. Asagidaki onceki V21 ozeti tarihsel baglamdir; guncel kaynak degildir.
...
Bu kapi kural SHA bagini, `DEC-259`–`DEC-269` karar senkronunu, 55 is kaydini, JSON semalarini, dis kanit durumlarini, kanal yalitimini, eski installer temizligini, gorunur kanal tekillestirmesini ve her islem oncesi kural kontrolunu fail-closed denetler. Ayni kapi `GOVERNED_PREFLIGHT` icinde zorunludur.

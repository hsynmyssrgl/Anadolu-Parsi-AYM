...
- PPK-021 current gate 555 üretim dosyasında 873 privileged yüzeyi exact SHA-256 `843cb93dce2402bbaeb3d44b5538b88a3a55f4832436ad23aaf61937bc8c99dc` ile PASS ölçer (`17/17` targeted, `84/84` contract, `20/20` runtime). Bu build-time AST kanıtı runtime PEP veya OCR acceptance yerine geçmez.
- PPK-022 current gate 555 üretim dosyasında 392 capability yüzeyini exact SHA-256 `cb879c739cb8ef3a2e92d1f0e451cd21ba7e9d4b0fcd519f343cddd725c9745c` ile PASS ölçer (`19/19` targeted, `110/110` contract, `24/24` runtime, `19/19` canonical availability). `windows-desktop` aggregate `ocr.process` capability’si ayrı `ocr-worker` uygulama kimliği veya düşük yetki sandbox kanıtı değildir; `ocr-worker=[]` korunur.

...
- PPK-021 current gate 563 üretim dosyasında 886 privileged yüzeyi exact SHA-256 `58a90febf9382776c2b1472e6ffd6a645c9a24a4cd69e499a8afc1fff2e72b30` ile PASS ölçer (`17/17` targeted, `84/84` contract, `20/20` runtime). Bu build-time AST kanıtı runtime PEP veya OCR acceptance yerine geçmez.
- PPK-022 current gate 563 üretim dosyasında 422 capability yüzeyini exact SHA-256 `dc0234d84a50ff1872f9cde4fb7ab286446b236a69019034055fa938dbb3be1e` ile PASS ölçer (`19/19` targeted, `110/110` contract, `24/24` runtime, `19/19` canonical availability). `windows-desktop` aggregate `ocr.process` capability’si ayrı `ocr-worker` uygulama kimliği veya düşük yetki sandbox kanıtı değildir; `ocr-worker=[]` korunur.

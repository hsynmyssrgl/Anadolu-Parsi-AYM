...
- PPK-021 current gate 442 üretim dosyasında 685 privileged yüzeyi exact SHA-256 `7713c4b422c9822f6a5505b7245e27032f34872e98843d3126cf6de9a285759e` ile PASS ölçer (`17/17` targeted, `84/84` contract, `20/20` runtime). Bu build-time AST kanıtı runtime PEP veya OCR acceptance yerine geçmez.
- PPK-022 current gate 442 üretim dosyasında 345 capability yüzeyini exact SHA-256 `1b8625264023eb79d3f36a3c25ca19480569bea6aa1f4589841b1b4d14d5ec3e` ile PASS ölçer (`19/19` targeted, `110/110` contract, `24/24` runtime, `19/19` canonical availability). `windows-desktop` aggregate `ocr.process` capability’si ayrı `ocr-worker` uygulama kimliği veya düşük yetki sandbox kanıtı değildir; `ocr-worker=[]` korunur.

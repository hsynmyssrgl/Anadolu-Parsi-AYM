...
Bu kararın uygulanmasında gerçek test hataları `5d56bcac`, `a7d50f72`, `925d25d1`, `e42f9b58`, `4894345b`, `88fb84f8`, `447eb103`, `90b0fb0f`, `5490c2b4` ve `284545ff` reddedilmiş checkpointleriyle korunmuştur; bunlar PASS veya sürüm kabulü değildir. `284545ff`, resmî ana build ledger üreticisinin çift satır sonu üretmesini `git diff --check` kapısında kaydeder; düzeltme yalnız çıktıya değil kanonik üreticiye uygulanır.

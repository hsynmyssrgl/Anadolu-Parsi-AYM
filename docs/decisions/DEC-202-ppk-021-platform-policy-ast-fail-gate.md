...
Core Service companion, yerel ürün lisansı, fabrika ayarına dönüş, kaldırma yedeği, şifreli sürüm-geçiş kasası, 33-W yerel model ve çevrimdışı aile haritası bağları sonrasındaki güncel source ratchet, tarihsel kapanış kanıtını yeniden yazmadan, 18 zone / 568 dosya / 889 exact yüzeyi sıfır bulguyla bağlar. Harita kaynağı yeni privileged AST yüzeyi eklemez; beş salt-okunur dosya importu PPK-022 tarafından ayrı olarak envanterlenir. Mevcut üç yüzey yalnız exact iki aile-AI kullanım senaryosu composition'ı ve `127.0.0.1` Ollama döngüsel taşıması içindir; genel uzak ağ yetkisi, gizli anahtar, yetki tokenı veya dosya yolu renderer'a açılmaz. Güncel allowlist SHA-256 değeri `3a297f74d43d4675090a709d4359af9245c2971a7fc338afef2fb87b1c8608dd` olarak sabitlenmiştir.

...
Core Service companion, yerel ürün lisansı, fabrika ayarına dönüş, kaldırma yedeği ve şifreli sürüm-geçiş kasası sonrasındaki güncel source ratchet, tarihsel kapanış kanıtını yeniden yazmadan, 18 zone / 563 dosya / 886 exact yüzeyi sıfır bulguyla bağlar. Yeni sekiz kripto yüzeyi yalnız main-process yerel lisans imzası/doğrulaması, yedek bütünlük özeti ve rastgele yerel kimlik üretimi içindir; gizli anahtar, yetki tokenı veya dosya yolu renderer'a açılmaz. Güncel allowlist SHA-256 değeri `58a90febf9382776c2b1472e6ffd6a645c9a24a4cd69e499a8afc1fff2e72b30` olarak sabitlenmiştir.

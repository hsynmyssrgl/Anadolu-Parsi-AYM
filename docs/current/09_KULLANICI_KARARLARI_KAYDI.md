...
- `DEC-274` — Windows teslimi Bronze 50 bootstrap veya Bronze 51+ exact continuation modunu yeniden türeten UAT110 V3, zorunlu installer-experience, parent-run bağlı UAT111 V3, exact kanonik rota, tüm uygun kontroller, gerçek native CANCEL/ACCEPT, exclusive reparse-korumalı kanıt kökü ve final V3 canlı geri-okuma zinciri olmadan kapanamaz

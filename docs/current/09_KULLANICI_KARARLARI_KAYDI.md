...
- `DEC-275` — En küçük değişiklik dahi etkilenen tüm kaynak, sicil, belge, iş listesi, manifest/indeks, ana DOCX/PDF ve kanıt sözleşmelerini aynı zincirde günceller; hedefli ve tam test ile UI etkisinde bütün etkileşim/görsel UAT tamamlanmadan ve gerçek hatalar `wip(rejected)` kaydedilmeden paket üretilemez. `65db62ad` 34-B–34-F, `90b5ad40` 34-G–34-K ve `4c6652e0` PPK-022 masaüstü başlangıç alt zincirindeki no-write aktarım kusurlarını; `47af84bd`/`b34e951b` DOCX render altyapı hatalarını; `10282bf4` çift `ADR-039` kimliğini ve `9f2aaf86` ilk kimlik kapısının yanlış-pozitifini FAIL olarak korur. Son düzeltmeden sonra kaynak regresyonu 1 dosya/6 test, masaüstü çalışma 51/51, sözleşme 41/41 ve uçtan uca PPK-022 24/24 PASS; 1.571 doğrulama dosyasında sıfır değişiklik görülmüştür. Önceki 34-B 13/13 + altı makbuz ve 34-G 37/37 + üç makbuz değişmezliği, nihai ana belge 28/28 görsel QA ve kimlik kapısı 2 dosya/12 test PASS sonuçları korunur. Yeni exact tam regresyon ve kurulu tam UI UAT zorunludur

...
- `DEC-253` ile Windows kurulum karşılama ve kuruluma hazır ekranları hafif, yerel ve ağsız animasyonlara; ilk açılış anlatımı görünür üç adıma bağlanmıştır. Kullanıcı anlatımı durdurabilir, yeniden başlatabilir, yavaşlatabilir veya sessize alabilir; metin her durumda görünür kalır.

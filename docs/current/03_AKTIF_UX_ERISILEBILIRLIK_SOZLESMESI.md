...
- `DEC-254` gereği kullanıcıya görünen marka `ParsYuva`, ürün adı `ParsYuva AYM`dir. Açık uzun ad yalnız kısaltmayı açıklayan ayrı tanıtım veya hukuk metninde kullanılabilir; başlıkta ürün adıyla birlikte tekrarlanamaz. Önceki marka yalnız yükseltme uyumluluğu gereken teknik kimliklerde kalabilir.

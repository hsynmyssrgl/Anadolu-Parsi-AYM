...
- PR-240 filtrelenmemiş kanal regresyonu: **FAIL KAYITLI; 47/47 EK KOMUT ÖN KOŞUMU PASS, EXACT EVIDENCE PENDING** — `a7d50f72`, `925d25d1`, `e42f9b58`, `4894345b`, `88fb84f8`, `447eb103`, `90b0fb0f`, `5490c2b4` ve `284545ff` reddedilmiş checkpointleri korunur. Sınıflandırma canlı JSON stdout ve kanonik `.50` metasına, salt-okunur doğrulayıcılar exact Git ana/kanal köküne, data-store smoke tekrarlanabilir derleme wrapper'ına bağlandı. PPK-015 canlı kapısı tarihsel scope özeti yerine kanonik current ratchet'in bütün alanlarını karşılaştırır; 34-G–34-K dahil 47 komutluk katalog PASS oldu. Ana build ledger üreticisindeki çift son satır `git diff --check` ile reddedildi ve üreticide tek son satır standardına düzeltildi. Değişmeyen bağımlı kayıtlar baseline diff yokluğu, gerekçe ve üçlü SHA readback bağıyla `NOT_AFFECTED` olabilir; sahte/no-op değişiklik yoktur. Yeni temiz exact commit tam regresyonu ve kaynak bütünlüğü olmadan paket yoktur.

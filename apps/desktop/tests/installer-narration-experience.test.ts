...
describe('installer progress, narration and Silver help experience', () => {
  it('uses a transitional narrated welcome while reserving progress for real file installation', async () => {
    ...
    expect(narration).toContain('$synthesizer.SetOutputToWaveFile($waveTarget)');
    ...
    expect(narration).toContain('(Get-FileHash -Algorithm SHA256 -LiteralPath $waveTarget).Hash.ToLowerInvariant()');

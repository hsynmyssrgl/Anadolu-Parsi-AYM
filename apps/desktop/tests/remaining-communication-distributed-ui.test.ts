...
describe('34-G/H/I/J fail-honest renderer surfaces',()=>{it('exposes local controls without claiming unavailable providers',()=>{
  ...
  for(const marker of ['Haricî dosya aktarımı ve zararlı dosya tarama hizmeti yapılandırılmamıştır.','acil servis değildir',
    'İşlem geçmişi mesaj, dosya, görüşme veya tutanak içeriğini kopyalayamaz.','Henüz işlem geçmişine eklenen bir iletişim değişikliği yapılmadı.',

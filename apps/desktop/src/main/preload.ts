...
contextBridge.exposeInMainWorld('pardus', {
  ...
  getFamilyAiLocalModelStatus:():Promise<FamilyAiLocalModelStatusView>=>invoke('familyAiAssistant:getLocalModelStatus'),
  runFamilyAiLocalModel:(input:RunFamilyAiLocalModelInput):Promise<FamilyAiLocalModelResponseView>=>
    invoke('familyAiAssistant:runLocalModel',input),

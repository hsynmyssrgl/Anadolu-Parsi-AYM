...
export const COMPATIBILITY_IPC_CHANNELS = new Set([
  ...
  'archive:updateClassification','archive:operationIdentity:acknowledge','archive:operationIdentity:acquire',
  'audit:list','audit:verifyIntegrity','automation:create',

...
const exactCopy:Readonly<Record<string,string>>={
  ...
  'Olay ve yerel sınırlama':'Incident and local containment','Yerel inceleme olayı aç':'Open local review incident','Uzaktan silme, cihaz yönetimi veya ağ teslimi yapılmadı':'Remote deletion, device management, and network delivery were not performed',
  'Yerel sınırlamaya al':'Contain locally','Yerel çözümü kaydet':'Save local resolution','Yerel olayı iptal et':'Cancel local incident',
  ...
  'Olay yerel sınırlama kaydı olarak açıldı.':'The incident was opened as a local containment record.','Olay yalnız yerel sınırlama durumuna alındı.':'The incident was placed only in local containment.','Olay yalnız yerel kayıtta iptal edildi.':'The incident was cancelled only in the local record.','Yerel olay çözüm notuyla kapatıldı; uzaktan silme, cihaz yönetimi veya ağ teslimi yapılmadı.':'The local incident was closed with a resolution note; remote deletion, device management, and network delivery were not performed.',

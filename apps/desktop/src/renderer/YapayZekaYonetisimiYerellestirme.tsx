...
const exactCopy: Readonly<Record<string,string>> = {
  ...
  'Ayrı dışa gönderim onayı etkin':'Separate export consent active','Hassasiyet profili':'Sensitivity profile',
  'Güvenli dışa gönderim':'Secure export','Derhal iptal et':'Revoke immediately','Doğal dil arama':'Natural-language search',

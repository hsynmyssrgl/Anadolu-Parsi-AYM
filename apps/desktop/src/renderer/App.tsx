...
export function SystemManagementScreen({draftCenterVisible=false,onDraftCenterVisibilityChange=()=>undefined}:{readonly draftCenterVisible?:boolean;readonly onDraftCenterVisibilityChange?:(visible:boolean)=>void}={}){
  ...
  {activeSystemModule==='operations'&&<div id="system-module-operations" aria-busy={operationsLoading}>{operationsLoading?<AsyncStatePanel state="loading" title="Sistem verileri hazırlanıyor" message="Operasyon, yedekleme ve politika kayıtları güvenli sırayla yükleniyor."/>:operationsLoadError?<AsyncStatePanel state="error" title="Sistem verileri yüklenemedi" message={operationsLoadError} retryLabel="Yeniden dene" onRetry={refresh}/>:<>

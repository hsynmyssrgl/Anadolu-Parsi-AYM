...
if ($build -ne 221) { throw "Unified Bronze Windows security lifecycle requires Build221; current build=$build." }
...
if (-not $EvidencePath) { $EvidencePath = Join-Path $validationRoot "build221-bronze-security-windows-release-lifecycle.json" }

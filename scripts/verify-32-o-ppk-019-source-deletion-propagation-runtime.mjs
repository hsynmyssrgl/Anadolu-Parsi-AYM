...
const commands = [
  ...
  { id: 'ppk-019-policy-repository-cache-backup-targeted', before: changedPackageBuilds, args: ['node_modules/vitest/vitest.mjs', 'run', 'apps/desktop/tests/ppk019-source-deletion-propagation.test.ts', '--reporter=dot', '--maxWorkers=1'], minimumTests: 20 },
  ...
  { id: 'migration-77-no-ppk019-schema-change', before: [['node_modules/typescript/bin/tsc', '-p', 'packages/database/tsconfig.json'], ['node_modules/typescript/bin/tsc', '-p', 'tests/smoke/tsconfig.data-store.json']], args: ['scripts/verify-database-migrations.mjs'], expectOutput: '"version": 77' },

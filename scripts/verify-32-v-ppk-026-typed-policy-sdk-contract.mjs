...
export const verifyPpk026TypedPolicySdkContract = async (root = process.cwd()) => {
  ...
  check('no package-owned repository persistence or migration was added', scope?.boundaries?.repositoryPersistenceRequired === false && scope?.boundaries?.schemaMigrationRequired === false && migrationVersions.includes(77) && latestMigration >= 77);

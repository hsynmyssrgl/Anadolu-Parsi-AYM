...
const definitions=[
  ...
  ['renderer states consent local no-action and source-coverage truth',has(panel,['Yerel ve onaylı çalışma sınırı','Ağ, bulut veya model çıkarımı kullanılmaz','ödeme, rezervasyon, sağlık, acil durum','Kaynak izni geri çekilirse öneri görünmez olur','kaynak kapsam göstergesi','inactiveConsentSuggestions'])],

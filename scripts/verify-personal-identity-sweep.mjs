...
if(!noWrite){await mkdir('artifacts/validation',{recursive:true}); await writeFile(`artifacts/validation/build${build}-personal-identity-sweep.json`,JSON.stringify(report,null,2)+'\n');}

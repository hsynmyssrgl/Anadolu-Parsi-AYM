...
check('latest database migration remains 77 with no PPK-017 migration', latestMigration === 77 && !files.migrations.includes('ppk017') && scope.boundaries?.schemaMigrationRequired === false);

...
const definitions=[
  ...
  ['PPK ratchets are exact while requirement remains open',scope.validation?.ppk021?.scannedProductionFiles===462&&scope.validation?.ppk021?.exactPrivilegedSurfaceCount===715&&scope.validation?.ppk021?.exactAllowlistSha256==='2e1962cc032e83ef84128f7aa4e266d2f70ca12178c48c5109d6e1849df3073b'&&scope.validation?.ppk022?.scannedProductionFiles===462&&scope.validation?.ppk022?.exactCapabilitySurfaceCount===345&&scope.validation?.ppk022?.exactCapabilityManifestSha256==='1b8625264023eb79d3f36a3c25ca19480569bea6aa1f4589841b1b4d14d5ec3e'&&scope.validation?.countsAsRequirementPass===false&&inventory.validation?.countsAsRequirementPass===false]
];

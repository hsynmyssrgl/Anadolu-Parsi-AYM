...
if ($build -ne 222) { throw "Unified Bronze Windows security lifecycle requires Build222; current build=$build." }
...
if (-not $EvidencePath) { $EvidencePath = Join-Path $validationRoot "build222-bronze-security-windows-release-lifecycle.json" }

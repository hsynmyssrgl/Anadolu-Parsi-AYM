...
const commands = [
  ...
  { id: 'ppk-016-targeted-policy-use-case-schema', args: ['node_modules/vitest/vitest.mjs', 'run', 'apps/desktop/tests/ppk016-derived-data-policy-inheritance.test.ts', '--reporter=dot', '--maxWorkers=1'], minimumTests: 75 },
  ...
  { id: 'migration-77-metadata-runtime', before: [['node_modules/typescript/bin/tsc', '-p', 'packages/database/tsconfig.json']], args: ['scripts/verify-database-migrations.mjs'], expectOutput: '"version": 77' },
...
const report = {
  ...
  validatedBoundaries: [
    ...
    'MIGRATION_77_METADATA_ONLY_SEALED_IMMUTABILITY',
    'ZERO_CURRENT_DERIVED_PAYLOAD_PRODUCER_ADAPTERS',

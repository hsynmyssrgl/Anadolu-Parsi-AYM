...
if ($build -ne 220) { throw "Unified Bronze Windows security lifecycle requires Build220; current build=$build." }
...
if (-not $EvidencePath) { $EvidencePath = Join-Path $validationRoot "build220-bronze-security-windows-release-lifecycle.json" }

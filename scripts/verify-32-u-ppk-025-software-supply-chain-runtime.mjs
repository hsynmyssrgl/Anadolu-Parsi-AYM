...
const report = {
  ...
  validatedBoundaries: [
    ...
    'CYCLONEDX_1_6_EXACT_414_COMPONENT_AND_DEPENDENCY_COVERAGE',
    'EXACT_374_CANONICAL_REGISTRY_PACKAGES_WITH_SHA512_INTEGRITY',
    'EXACT_357_LICENSE_AND_THIRD_PARTY_NOTICE_COMPONENTS',
  ...
  sbomComponents: 414,
  dependencyNodes: 414,
  registryPackages: 374,
  licenseComponents: 357,

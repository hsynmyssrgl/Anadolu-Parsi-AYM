...
check(['31-T', '33-D', '33-E', '33-F', '33-G'].includes(audit.currentStep) && audit.percentages.officialWeightedEvidenceStep === '31-T', 'Bronze audit active checkpoint or historical weighted-evidence checkpoint is invalid');

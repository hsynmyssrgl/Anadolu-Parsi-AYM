...
check('repository persistence binding exposes the complete operation binding', ['contextHash: authorization.contextHash', 'resourceFamilyId: authorization.resourceFamilyId', 'purpose: authorization.purpose', 'occurredAt: authorization.occurredAt'].every((marker) => sources.repository.includes(marker)));

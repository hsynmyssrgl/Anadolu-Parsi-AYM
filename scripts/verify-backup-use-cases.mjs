...
let store;
try{
 store=new FamilyDataStore({databasePath:join(directory,'family.db'),applicationVersion:'24.07.2026.60',migrationBackupDirectory:join(directory,'migration-backups')});

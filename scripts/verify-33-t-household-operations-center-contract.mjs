...
const definitions=[
  ...
  ['production policy runtime binds collection create replay and exact existing item metadata',hasAll(runtime,["resourceType === 'household_operation_item'","requestedIntent.resourceType !== 'household_operation_item'",'existing.value.stateFingerprint',"sensitivity: requestedIntent.resourceType === 'household_operations_center'"])],

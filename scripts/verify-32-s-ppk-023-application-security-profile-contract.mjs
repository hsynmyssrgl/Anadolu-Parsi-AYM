...
check('PPK-021 successor AST ratchet remains green', astGate.status === 'PASS' && astGate.productionSourceZones === 18 && astGate.scannedFiles >= 365 && astGate.privilegedSurfaces === 521 && astGate.exactAllowlistEntries === 521 && astGate.findings.length === 0);

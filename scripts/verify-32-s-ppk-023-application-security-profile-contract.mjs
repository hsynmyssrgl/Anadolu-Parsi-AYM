...
check('PPK-021 successor AST ratchet remains green', astGate.status === 'PASS' && astGate.productionSourceZones === 18 && astGate.scannedFiles >= 381 && astGate.privilegedSurfaces === 545 && astGate.exactAllowlistEntries === 545 && astGate.findings.length === 0);

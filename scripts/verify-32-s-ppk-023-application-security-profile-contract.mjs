...
check('PPK-021 successor AST ratchet remains green', astGate.status === 'PASS' && astGate.productionSourceZones === 18 && astGate.scannedFiles >= 376 && astGate.privilegedSurfaces === 542 && astGate.exactAllowlistEntries === 542 && astGate.findings.length === 0);

...
check('PPK-021 successor AST ratchet remains green', astGate.status === 'PASS' && astGate.productionSourceZones === 18 && astGate.scannedFiles >= 376 && astGate.privilegedSurfaces === 537 && astGate.exactAllowlistEntries === 537 && astGate.findings.length === 0);

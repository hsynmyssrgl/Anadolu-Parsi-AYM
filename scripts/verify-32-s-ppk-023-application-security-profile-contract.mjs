...
check('PPK-021 successor AST ratchet remains green', astGate.status === 'PASS' && astGate.productionSourceZones === 18 && astGate.scannedFiles >= 375 && astGate.privilegedSurfaces === 528 && astGate.exactAllowlistEntries === 528 && astGate.findings.length === 0);

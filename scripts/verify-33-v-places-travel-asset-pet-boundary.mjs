...
const definitions=[
  ...
  ['renderer reuses Life route and presents meaningful local summaries',has(panel,['Yer ve seyahat merkezi','Harita, rezervasyon, ödeme','OCR kimliği sadece öneri referansıdır','Evcil hayvan kaydı sağlık tavsiyesi değildir','itemSummary(item,text)','Opak seyahat / gider referansı'])],

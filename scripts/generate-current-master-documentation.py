...
DRIFT_FIXES = [
    ...
    f"Bronze 53 final preflight kayit zincirinde teknik predecessor producer parse reti 219836c6, PR-241 enforcement expected-list drifti d3f218c1, belge render PATH reti ace2eeaf ve master marker drifti 453e8c59 korunur. Aktif son kaynak reti {ledger['activeDeliveryClosure']['latestRejectedCheckpoint']} kayit defterinden dinamik okunup Markdown, DOCX ve PDF'ye tasinir; taze exact preflight, paket ve kurulu UAT PASS olmadan teslim yoktur.",
]

...
check('STATIC_WELCOME_REAL_PROGRESS_ONLY', !installer.includes('CreateTimer') && !installer.includes('KillTimer') && installer.includes('This page performs no installation work') && installer.includes('MUI_PAGE_CUSTOMFUNCTION_SHOW AymInstallFilesShow'), 'custom welcome and ready pages are static; native install-files progress is the only moving progress');

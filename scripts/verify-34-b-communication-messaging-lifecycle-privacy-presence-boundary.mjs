...
const checks=[
  ...
  ['renderer reuses system screen and states local-only limits',has(panel,['CommunicationMessagingPanel','Bu sürüm yalnız yerel ve ağsız çalışır.',
    'İçeriği açıkça göster','Uzak teslim','fiziksel güvenli silme','Dosya ekleri güvenli dosya seçicisinden alınır',
  ...
  ['local ratchet is exact without granting requirement pass',scope.validation?.targetedTestFileRatchet===5
    ...
    &&scope.validation?.ppk015?.status==='PASS'&&scope.validation?.ppk015?.files===590
    &&scope.validation?.ppk015?.sourceSha256==='a739c17e51942946e2e6923d8ac7524630e36b56ec1078671eddf351b64e6f93'
    &&scope.validation?.ppk021?.status==='PASS'&&scope.validation?.ppk021?.surfaces===897
    &&scope.validation?.ppk021?.sha256==='9ea5b846e552e760fbd8dd5f8bee7fb83988ef19bb93e3bbd4ac0465c4b71205'
    &&scope.validation?.ppk022?.status==='PASS'&&scope.validation?.ppk022?.surfaces===447
    &&scope.validation?.ppk022?.sha256==='54061e189e7771868552efa869c69a75426f24e4edd846af1c62496c82f0e1d6'

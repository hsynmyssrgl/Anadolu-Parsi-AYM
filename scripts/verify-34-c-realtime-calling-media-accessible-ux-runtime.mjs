...
results.push(run('targeted 5 files 23 tests',node,npmArgs(['run','verify:34-c:targeted'])));
...
console.log(`34-C runtime: PASS (${results.length}/${results.length}; 5 files/23 tests; requirement PASS=false; write=${!noWrite}).`);

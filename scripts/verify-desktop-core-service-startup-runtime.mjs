...
try{
 ...
 check(connection.health.policyPackage.payload.applicationManifests['windows-desktop']?.runtimeCapabilities.join('|')==='file.access|network.access|ocr.process','startup did not preserve exact signed Desktop runtime capability coverage');

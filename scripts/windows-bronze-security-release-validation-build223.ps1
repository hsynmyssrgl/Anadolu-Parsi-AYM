...
if ($build -ne 223) { throw "Unified Bronze Windows security lifecycle requires Build223; current build=$build." }
...
if (-not $EvidencePath) { $EvidencePath = Join-Path $validationRoot "build223-bronze-security-windows-release-lifecycle.json" }

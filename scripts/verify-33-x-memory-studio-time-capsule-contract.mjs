...
const definitions=[
  ...
  ['PPK ratchets are exact PASS while requirement remains open',p21.status==='PASS'&&p21.scannedProductionFiles===480&&p21.exactPrivilegedSurfaceCount===740&&p21.exactAllowlistSha256==='be7f27d47e2aa592dd2dc4d077222c030632a346eaad3014288b9b4b8bacf83e'&&p22.status==='PASS'&&p22.scannedProductionFiles===480&&p22.exactCapabilitySurfaceCount===345&&p22.exactCapabilityManifestSha256==='1b8625264023eb79d3f36a3c25ca19480569bea6aa1f4589841b1b4d14d5ec3e'&&scope.validation.countsAsRequirementPass===false]
];

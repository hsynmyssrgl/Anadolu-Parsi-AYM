...
const definitions=[
  ...
  ['renderer states capacity retention and provider no-claim boundary',has(panel,['Gizli gözetim yasaktır','en çok 60 dakikadır','otomatik retention kurtarması uygulanmadı','Matter eşleme','cihaz kontrolü','bu pakette yapılmadı'])],

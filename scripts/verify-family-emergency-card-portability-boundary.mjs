...
export const verifyFamilyEmergencyCardPortabilityBoundary = async () => {
  ...
  check('platform policy AST successor ratchet is exact green', astGate.status === 'PASS'
    && astGate.privilegedSurfaces === 682 && astGate.exactAllowlistEntries === 682
    && astGate.surfaceCounts?.USE_CASE_COMPOSITION === 325 && astGate.directRoleAuthorizationBypasses === 0);

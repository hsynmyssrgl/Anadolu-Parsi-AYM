...
export const verifyFamilyEmergencyCardPortabilityBoundary = async () => {
  ...
  check('platform policy AST successor ratchet is exact green', astGate.status === 'PASS'
    && astGate.privilegedSurfaces === 740 && astGate.exactAllowlistEntries === 740
    && astGate.surfaceCounts?.USE_CASE_COMPOSITION === 358 && astGate.directRoleAuthorizationBypasses === 0);

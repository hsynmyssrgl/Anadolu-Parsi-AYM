...
export const verifyFamilyEmergencyCardPortabilityBoundary = async () => {
  ...
  check('platform policy AST successor ratchet is exact green', astGate.status === 'PASS'
    && astGate.privilegedSurfaces === 730 && astGate.exactAllowlistEntries === 730
    && astGate.surfaceCounts?.USE_CASE_COMPOSITION === 352 && astGate.directRoleAuthorizationBypasses === 0);

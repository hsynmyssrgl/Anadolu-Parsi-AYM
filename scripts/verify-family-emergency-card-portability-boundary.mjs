...
export const verifyFamilyEmergencyCardPortabilityBoundary = async () => {
  ...
  check('platform policy AST successor ratchet is exact green', astGate.status === 'PASS'
    && astGate.privilegedSurfaces === 817 && astGate.exactAllowlistEntries === 817
    && astGate.surfaceCounts?.USE_CASE_COMPOSITION === 403 && astGate.directRoleAuthorizationBypasses === 0);

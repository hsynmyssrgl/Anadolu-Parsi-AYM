...
export const verifyFamilyEmergencyCardPortabilityBoundary = async () => {
  ...
  check('platform policy AST successor ratchet is exact green', astGate.status === 'PASS'
    && astGate.privilegedSurfaces === 707 && astGate.exactAllowlistEntries === 707
    && astGate.surfaceCounts?.USE_CASE_COMPOSITION === 341 && astGate.directRoleAuthorizationBypasses === 0);

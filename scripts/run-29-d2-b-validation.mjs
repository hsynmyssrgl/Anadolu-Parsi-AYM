...
const commands = [
  ...
  { name: '29-D2-B-document-inventory', script: 'scripts/verify-29-d2-b-document-inventory.mjs' }
];
const results = [];
let failed = false;
...
const report = {
  ...
  workStep: '29-D2-B',
  phase: 'GOVERNED_PREFLIGHT_AND_DOCUMENT_INVENTORY',
...
await writeFile('artifacts/validation/29-D2-B-validation-evidence.json', `${JSON.stringify(report, null, 2)}\n`);
...
console.log('29-D2-B combined validation: PASS.');

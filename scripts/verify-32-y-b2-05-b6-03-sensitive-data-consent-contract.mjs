...
check('PPK-021 successor ratchet is exact green with no role bypass', astGate.status === 'PASS' && astGate.privilegedSurfaces === 537 && astGate.exactAllowlistEntries === 537 && astGate.directRoleAuthorizationBypasses === 0 && astGate.findings.length === 0);

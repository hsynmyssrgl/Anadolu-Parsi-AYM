...
check('PPK-021 successor ratchet is exact green with no role bypass', astGate.status === 'PASS' && astGate.privilegedSurfaces === 545 && astGate.exactAllowlistEntries === 545 && astGate.directRoleAuthorizationBypasses === 0 && astGate.findings.length === 0);

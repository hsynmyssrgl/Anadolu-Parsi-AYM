...
echo Build226 / 02.08.2026.226
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\run-build226-bronze-security-closure.ps1"
...
echo.
echo artifacts\validation klasorundeki Bronze_Guvenlik_Windows_Kanitlari_Build226_*.zip ve .sha256 dosyalarini saklayin.
pause
